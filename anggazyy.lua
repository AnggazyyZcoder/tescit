...
InfoTab:CreateParagraph({
    ...
    Content = "Auto Fishing System • Coordinate Tracking • Player Teleportation • Performance Boosts • Real-time Monitoring"
})
...
Notify({
    ...
    Content = "Premium fishing automation system ready\nPress [K] to toggle interface",
    Duration = 5
})
